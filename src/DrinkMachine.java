...
public class DrinkMachine{
    ...
    public static void main(String[] args) throws IOException {
    	...
    	System.out.println("Enter the number of outlets for service");
    	N = scan.nextInt();
    	System.out.printf("No of outlets" + N);
        addAllIngredients();
        addAllDrinks();
        updateCosts();
        updateMakeable();
    ...
    public static void startIO() throws IOException {
        ...
        while(true){            
            try {
                ...
                System.out.printf("selection is" + input);
                ...
                if(input.equals("")){
                	...
                	System.out.printf("count" +outlets);
                	System.out.printf("N" +N);
                	if(outlets<N) {
                		outlets++;
                    makeDrink(drinkList.get(Integer.parseInt(input)-1));
                	} else {
                		System.out.printf("All outlets busy please wait");
                	}
                }else{
